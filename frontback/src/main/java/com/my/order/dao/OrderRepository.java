...
public class OrderRepository {
	...
	private void insertInfo(Connection conn, OrderInfo info) throws AddException{
		...
		String InsertSQL = "INSERT INTO order_info(order_no, order_id, order_dt)\r\n"
	...
	private void insertLine(Connection conn, OrderLine line) throws AddException{
		...
		//(DB와의 연결에서 NEXTVAL없이 CURRVAL 할 수 없다)
		//DB와 연결해제
		String InsertSQL = "INSERT INTO order_line(order_no, order_prod_no, order_quantity)\r\n"
